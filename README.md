...
## Настройка
* Добавьте интеграцию в Home Assistant: Настройки > Устройства и службы > Интеграции > Добавить интеграцию > `Yandex.Station Intents` (если интеграции нет в списке - обновите страницу)
